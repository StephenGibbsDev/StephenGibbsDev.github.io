...
var WeatherDetailsService = /** @class */ (function () {
    //list:Weather[];
    ...
    WeatherDetailsService.prototype.initWeatherData = function () {
        return this.http.get(this.rootUrl);
    };
    WeatherDetailsService.prototype.refreshList = function () {
    ...
    WeatherDetailsService.ctorParameters = function () { return [
...
var WeatherDetailsComponent = /** @class */ (function () {
    function WeatherDetailsComponent(service) {
        this.service = service;
    }
    WeatherDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.initWeatherData().subscribe(function (response) {
...
var WeatherHeaderComponent = /** @class */ (function () {
    function WeatherHeaderComponent(service) {
        this.service = service;
    }
    WeatherHeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        // this.resetForm();
    ...
    //   }
    // }
    WeatherHeaderComponent.prototype.populateForm = function (wd) {
        console.log("Run populateForm");
        this.service.weatherData = Object.assign({}, wd);
    };
    WeatherHeaderComponent.ctorParameters = function () { return [
        { type: src_app_shared_weather_details_service__WEBPACK_IMPORTED_MODULE_2__["WeatherDetailsService"] }
    ]; };
...
var WeatherLandingComponent = /** @class */ (function () {
    function WeatherLandingComponent() {
    }
    WeatherLandingComponent.prototype.ngOnInit = function () {
    };
    ...
    return WeatherLandingComponent;
}());
